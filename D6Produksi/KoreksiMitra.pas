...
//  if BPBFrm=Nil then
  begin
    KoreksiMitraFrm:=TKoreksiMitraFrm.Create(Application);
    KoreksiMitraFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       KoreksiMitraFrm.QMaster.ReadOnly:=True;
       KoreksiMitraFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    KoreksiMitraFrm.Caption:=UpperCase(pjudul);
    KoreksiMitraFrm.vkode:=pkode;
    KoreksiMitraFrm.vjns_lokasi:=pjns_lokasi;
    KoreksiMitraFrm.vjns_brg:=pjns_brg;
    KoreksiMitraFrm.vjns_item:=pjns_item; //MAA 19-12-2019
    KoreksiMitraFrm.QTransaksi.Open;

    KoreksiMitraFrm.PanelHeader.Caption:=KoreksiMitraFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+KoreksiMitraFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    KoreksiMitraFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiMitraFrm.wwDBGrid1.IniAttributes.SectionName:=KoreksiMitraFrm.Caption+'1';
    KoreksiMitraFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    KoreksiMitraFrm.wwDBGrid1.LoadFromIniFile;
    KoreksiMitraFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiMitraFrm.wwDBGrid2.IniAttributes.SectionName:=KoreksiMitraFrm.Caption+'2';
    KoreksiMitraFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    KoreksiMitraFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KoreksiMitraFrm.Caption+'1',KoreksiMitraFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,KoreksiMitraFrm.Caption+'2',KoreksiMitraFrm.wwDBGrid2);
    KoreksiMitraFrm.wwDBSpinLine1.Value:=KoreksiMitraFrm.wwDBGrid1.RowHeightPercent;
    KoreksiMitraFrm.wwDBSpinLine2.Value:=KoreksiMitraFrm.wwDBGrid2.RowHeightPercent;
  end;

  KoreksiMitraFrm.Show;
end;

procedure TKoreksiMitraFrm.FormClose(Sender: TObject;
...
procedure TKoreksiMitraFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiMitraFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.BtnOkClick(Sender: TObject);
var
  vkg : real;
  vjam : string;
  vjam1,vjam2 : Integer;
...
procedure TKoreksiMitraFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiMitraFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKoreksiMitraFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiMitraFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiMitraFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiMitraFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiMitraFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.BtnOk2Click(Sender: TObject);
var
  vkgf: real;
begin
...
procedure TKoreksiMitraFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TKoreksiMitraFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TKoreksiMitraFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKoreksiMitraFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKoreksiMitraFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
...
procedure TKoreksiMitraFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiMitraFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiMitraFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Close;
...
procedure TKoreksiMitraFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiMitraFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TKoreksiMitraFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
procedure TKoreksiMitraFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiMitraFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiMitraFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Close;
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TKoreksiMitraFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiMitraFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  ...
  QMasterKD_DIV.AsString:='000';

  QMasterSTATUS.AsString:='IN';
  wwDBLookupComboDlg2.SetFocus;
end;

procedure TKoreksiMitraFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiMitraFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiMitraFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiMitraFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKoreksiMitraFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiMitraFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TKoreksiMitraFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TKoreksiMitraFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Close;
...
procedure TKoreksiMitraFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
//    QItem.Close;
...
procedure TKoreksiMitraFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  ...
  QDetailKD_SUB_LOKASI.AsString:=vjns_lokasi+'-70000';
end;

procedure TKoreksiMitraFrm.QDetailBeforePost(DataSet: TDataSet);
begin
  ...
  begin
     ShowMessage('Arah Lusi/Pakan harus diisi !');
     Abort;
  end;
end;

procedure TKoreksiMitraFrm.FormShow(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.QDetailQTY6Change(Sender: TField);
begin
...
procedure TKoreksiMitraFrm.LookMesinEnter(Sender: TObject);
begin
  QLokasi.Close;
  QLokasi.SetVariable('pkd_lokasi',vjns_lokasi);
...
procedure TKoreksiMitraFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiMitraFrm.LookWarnaEnter(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  if (QDetailQTY4.AsFloat>0) then
    QDetailEFF.AsFloat:=100*QDetailQTY1.AsFloat/(QDetailQTY4.AsFloat);
end;

procedure TKoreksiMitraFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TKoreksiMitraFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
   ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TKoreksiMitraFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TKoreksiMitraFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TKoreksiMitraFrm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBDateTimePicker1.Enabled:=False;
end;

procedure TKoreksiMitraFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
//  vfilter:=vkd_benang;
...
procedure TKoreksiMitraFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  QDetailKETERANGAN.AsString:=QItemNAMA_ITEM.AsString;
  QDetailKD_ITEM2.AsString:=QItemKD_ITEM.AsString;
end;
