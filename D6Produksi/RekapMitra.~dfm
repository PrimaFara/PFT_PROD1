object RekapMitraFrm: TRekapMitraFrm
  Left = 193
  Top = 134
  Width = 1060
  Height = 486
  ...
  object PanelMain: TPanel
    ...
    object PageControl2: TPageControl
      ...
      object TabSheet1: TTabSheet
        Caption = 'Daftar Pengiriman Beam'
          ...
          object QuickRep2: TQuickRep
            ...
            object QRBand2: TQRBand
              ...
              object QRLabel21: TQRLabel
                ...
                AutoSize = True
                AutoStretch = False
                Caption = 'LAPORAN PRODUKSI DEPT DYEING'
                Color = clWhite
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -16
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'KP'#9'10'#9'KP'#9'F'
            'LUSI'#9'10'#9'ISI (KG)'#9'F'
            'OPR_INSERT'#9'20'#9'USER ENTRY'#9'F')
      ...
      object TabSheet2: TTabSheet
        Caption = 'Daftar Pengiriman Benang'
        ImageIndex = 1
        OnShow = TabSheet2Show
        object LBanner2: TLabel
          Left = 0
          Top = 57
          Width = 1036
          Height = 13
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'TGL'#9'18'#9'TGL'#9'F'
            'MITRA'#9'25'#9'MITRA'#9'F'
            'KD_ITEM'#9'7'#9'KD ITEM'#9'F'
            'NAMA_ITEM'#9'25'#9'NAMA ITEM'#9'F'
            'WARNA'#9'18'#9'WARNA'#9'F'
            'LUSI'#9'10'#9'LUSI'#9'F'#9'QTY (KG)'
            'PAKAN'#9'10'#9'PAKAN'#9'F'#9'QTY (KG)'
            'OPR_INSERT'#9'20'#9'USER ENTRY'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
      ...
      object TabSheet3: TTabSheet
        Caption = 'Daftar Penerimaan Sarung'
        ImageIndex = 2
        OnShow = TabSheet3Show
        object LBanner3: TLabel
          Left = 0
          Top = 57
          Width = 1036
          Height = 13
      ...
      object TabSheet4: TTabSheet
        Caption = 'Daftar Penerimaan Retur Beam'
        ImageIndex = 3
        object LBanner4: TLabel
          Left = 0
          Top = 57
          Width = 1036
          Height = 13
      ...
      object TabSheet5: TTabSheet
        Caption = 'Daftar Penerimaan Benang Retur'
        ImageIndex = 4
        object LBanner5: TLabel
          Left = 0
          Top = 57
          Width = 1036
          Height = 13
        ...
        object wwDBGrid5: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'MITRA'#9'25'#9'MITRA'#9'F'
            'KD_ITEM'#9'7'#9'KD ITEM'#9'F'#9'BENANG'
            'NAMA_ITEM'#9'25'#9'NAMA ITEM'#9'F'#9'BENANG'
            'WARNA'#9'15'#9'WARNA'#9'F'#9'BENANG'
            'LUSI'#9'10'#9'LUSI'#9'F'#9'QTY (KG)'
            'PAKAN'#9'10'#9'PAKAN'#9'F'#9'QTY (KG)'
            'OPR_INSERT'#9'15'#9'USER ENTRY'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetHTML
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vmaklon_kirim_beam'
      'where tgl>=:ptgl and tgl<=:ptgl2'
      ':myparam')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      
      4E53455254010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    ...
    object QBrowseLUSI: TFloatField
      FieldName = 'LUSI'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
    object QBrowsePAKAN: TFloatField
      FieldName = 'PAKAN'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db3.proc_lap_produksi(:vsysdate, :vsysdate2);'
      'end;'
      '')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowse2: TOracleDataSet
    SQL.Strings = (
      'select t.*, a.warna from ipisma_db3.vmaklon_kirim_benang t'
      'left join ipisma_db3.warna_baru a on a.kd_warna=t.kd_warna'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      410100000000000A0000004F50525F494E53455254010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    ...
    object QBrowse2MITRA: TStringField
      FieldName = 'MITRA'
      Size = 64
    end
    ...
    object QBrowse2LUSI: TFloatField
      FieldName = 'LUSI'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
    object QBrowse2PAKAN: TFloatField
      FieldName = 'PAKAN'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
  ...
  object QProcPerTgl: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db3.proc_lap_produksi1(:vsysdate, :vsysdate2);'
      'end;'
      '')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowse3: TOracleDataSet
    SQL.Strings = (
      ...
      'a.opr_insert'
      ''
      'from ipisma_db3.vmaklon_terima_sarong t'
      'left join ipisma_db5.hasil_tenun_mitra a on t.no_nota=a.no_nota'
      'where t.tgl between :ptgl and :ptgl2'
    ...
    Left = 188
    Top = 248
    object QBrowse3TGL: TDateTimeField
      FieldName = 'TGL'
    end
    object QBrowse3NO_NOTA: TStringField
      FieldName = 'NO_NOTA'
    end
    object QBrowse3NAMA_MITRA: TStringField
      FieldName = 'NAMA_MITRA'
      Size = 25
    end
    object QBrowse3KD_PRODUKSI: TStringField
    ...
    object QBrowse3QTY_PTG: TFloatField
      FieldName = 'QTY_PTG'
      DisplayFormat = '#,0.00;-#,0.00;-'
    end
    object QBrowse3LS_TERIMA_PRODUKSI: TFloatField
      FieldName = 'LS_TERIMA_PRODUKSI'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
    object QBrowse3PK_TERIMA_PRODUKSI: TFloatField
      FieldName = 'PK_TERIMA_PRODUKSI'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
    object QBrowse3PK_TERIMA_PRODUKSI2: TFloatField
      FieldName = 'PK_TERIMA_PRODUKSI2'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
  ...
  object QBrowse4: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vmaklon_terima_beam t'
      'where t.tgl between :ptgl and :ptgl2'
      ':myparam')
    Variables.Data = {
      0300000003000000050000003A5054474C0C0000000000000000000000060000
    ...
    QBEDefinition.QBEFieldDefs = {
      
      00004B50010000000000060000004953504F5354010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    ...
    object QBrowse4NAMA_MITRA: TStringField
      FieldName = 'NAMA_MITRA'
      Size = 30
    end
    ...
    object QBrowse4QTY_LUSI1: TFloatField
      FieldName = 'QTY_LUSI1'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
  ...
  object QBrowse5: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vmaklon_terima_benang t'
      'where t.tgl between :ptgl and :ptgl2'
      ':myparam')
    Variables.Data = {
      0300000003000000050000003A5054474C0C0000000000000000000000060000
    ...
    QBEDefinition.QBEFieldDefs = {
      
      4953504F5354010000000000050000005741524E41010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    ...
    object QBrowse5NO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Size = 22
    end
    object QBrowse5MITRA: TStringField
      FieldName = 'MITRA'
      Size = 64
    end
    ...
    object QBrowse5KD_WARNA: TStringField
      FieldName = 'KD_WARNA'
      Size = 6
    end
    object QBrowse5LUSI: TFloatField
      FieldName = 'LUSI'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
    object QBrowse5PAKAN: TFloatField
      FieldName = 'PAKAN'
      DisplayFormat = '#,0.000;-#,0.000;-'
    end
    ...
    object QBrowse5OPR_INSERT: TStringField
      FieldName = 'OPR_INSERT'
      Size = 30
    end
    object QBrowse5ISPOST: TStringField
      FieldName = 'ISPOST'
      Size = 1
    end
    object QBrowse5WARNA: TStringField
      FieldName = 'WARNA'
      Size = 50
    end
  end
