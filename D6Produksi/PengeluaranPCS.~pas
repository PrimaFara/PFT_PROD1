...
type
  TPengeluaranPCSFrm = class(TForm)
    PanelMain: TPanel;
    PanelHeader: TPanel;
    ...
    QResepNota: TOracleDataSet;
    QCekResepNJML: TFloatField;
...
var
  PengeluaranPCSFrm: TPengeluaranPCSFrm;
...
//  if BPBFrm=Nil then
  begin
    PengeluaranPCSFrm:=TPengeluaranPCSFrm.Create(Application);
    PengeluaranPCSFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PengeluaranPCSFrm.QMaster.ReadOnly:=True;
       PengeluaranPCSFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PengeluaranPCSFrm.Caption:=UpperCase(pkode+pjudul);
    PengeluaranPCSFrm.vkode:=pkode;
    PengeluaranPCSFrm.vjns_lokasi:=pjns_lokasi;
    PengeluaranPCSFrm.vjns_brg:=pjns_brg;
    PengeluaranPCSFrm.QTransaksi.Open;


    PengeluaranPCSFrm.PanelHeader.Caption:=PengeluaranPCSFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+PengeluaranPCSFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    PengeluaranPCSFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PengeluaranPCSFrm.wwDBGrid1.IniAttributes.SectionName:=PengeluaranPCSFrm.Caption+'1';
    PengeluaranPCSFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    PengeluaranPCSFrm.wwDBGrid1.LoadFromIniFile;
    PengeluaranPCSFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PengeluaranPCSFrm.wwDBGrid2.IniAttributes.SectionName:=PengeluaranPCSFrm.Caption+'2';
    PengeluaranPCSFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    PengeluaranPCSFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PengeluaranPCSFrm.Caption+'1',PengeluaranPCSFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PengeluaranPCSFrm.Caption+'2',PengeluaranPCSFrm.wwDBGrid2);
    PengeluaranPCSFrm.wwDBSpinLine1.Value:=PengeluaranPCSFrm.wwDBGrid1.RowHeightPercent;
    PengeluaranPCSFrm.wwDBSpinLine2.Value:=PengeluaranPCSFrm.wwDBGrid2.RowHeightPercent;

  end;

  PengeluaranPCSFrm.Show;
end;

procedure TPengeluaranPCSFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   PengeluaranPCSFrm:=Nil;
end;

procedure TPengeluaranPCSFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TPengeluaranPCSFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.BtnOkClick(Sender: TObject);
var
...
procedure TPengeluaranPCSFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPengeluaranPCSFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPengeluaranPCSFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPengeluaranPCSFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPengeluaranPCSFrm.vTglAwalChange(Sender: TObject);
begin
//  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
  vTglAkhir.Date:=(VTglAwal.Date); 
end;

procedure TPengeluaranPCSFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPengeluaranPCSFrm.BtnFindClick(Sender: TObject);
var
  t1, t2, t3, t4, t5, t6 : real;
begin
...
procedure TPengeluaranPCSFrm.BtnOk2Click(Sender: TObject);
var
  t1, t2, t3, t4, t5, t6 : real;
begin
  if QBrowse.QBEMode then
...
procedure TPengeluaranPCSFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TPengeluaranPCSFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPengeluaranPCSFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPengeluaranPCSFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPengeluaranPCSFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPengeluaranPCSFrm.TabSheet1Show(Sender: TObject);
begin
  varah:='';
  vresep:='';
  QMaster.Close;
...
procedure TPengeluaranPCSFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPengeluaranPCSFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=ppNo2.AsInteger+1;
  ppNomer.Caption:=IntToStr(ppDBQDetail.RecordNo+1);
end;

procedure TPengeluaranPCSFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
procedure TPengeluaranPCSFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPengeluaranPCSFrm.Label5Click(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
 // ppNo2.AsInteger:=0;
end;

procedure TPengeluaranPCSFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPengeluaranPCSFrm.FormCloseQuery(Sender: TObject;
...
procedure TPengeluaranPCSFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPengeluaranPCSFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TPengeluaranPCSFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Open;
end;

procedure TPengeluaranPCSFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  if vjns_brg<>'' then
  begin
...
procedure TPengeluaranPCSFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  BEGIN
...
procedure TPengeluaranPCSFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
//////////////////////////////////////////////////////
IF QMasterNO_RESEP.AsString='KELUAR PROSES' THEN
BEGIN
    QCekResep.Close;
    QCekResep.SetVariable('vno_resep',QDetailNO_BUKTI.AsString);
    QCekResep.Open;

    QResepNota.Close;
    QResepNota.SetVariable('vno_resep',QDetailNO_BUKTI.AsString);
    QResepNota.Open;

    if QCekResepNJML.AsInteger>0 then
    begin
         ShowMessage('>>> I N F O R M A S I <<<'+
         #13+' '+
         #13+'MAAF - NO.RESEP : '+QDetailNO_BUKTI.AsString+
         #13+' '+
         #13+'Sudah dipakai di NO.NOTA : '+QResepNotaNO_NOTA.AsString+
         #13+' '+
         #13+'Silahkan Anda Pilih NO.RESEP yang LAINNYA...'+
         #13+' '+
         #13+'>>> Terima Kasih Anda sudah membaca INFORMASI ini <<<');

         QDetailNO_BUKTI.AsString:='';
    end;
...
begin
  ...
  QResep.SetVariable('pnama_item', QItemKD_SUB_KEL.AsString);
  QResep.SetVariable('pkd_warna', QItemKD_WARNA.AsString);
  QResep.Open;}
end;

procedure TPengeluaranPCSFrm.LookResepUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QResep.Close;
  QResep.Open;
...
procedure TPengeluaranPCSFrm.QDetailBeforeOpen(DataSet: TDataSet);
begin

//arif
  //Qdetail.SetVariable('ibukti',vresep);
end;

procedure TPengeluaranPCSFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
  if QMasterISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure TPengeluaranPCSFrm.CheckBox1Click(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TPengeluaranPCSFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TPengeluaranPCSFrm.LookResepUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
Var
  vfilter : String;
begin
...
procedure TPengeluaranPCSFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TPengeluaranPCSFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TPengeluaranPCSFrm.QItemCalcFields(DataSet: TDataSet);
begin
//QItemRASIO2.AsFloat:=QItemQTY.AsFloat/QItemQTY2.AsFloat;
end;

procedure TPengeluaranPCSFrm.cbTransaksiCloseUp(Sender: TwwDBComboBox;
  Select: Boolean);
begin  {
////MAA 11-01-2020 {TRANSAKSI KOREKSI BISA ENTRY QTY PCS & KG
if (QTransaksiKD_TRANSAKSI.AsString='686') and (cbtransaksi.Text='KOREKSI') then
...
wwDBGrid1.Refresh;
wwDBGrid1.RefreshDisplay;                     }//270524 hsl meeting, agar KG bisa diedit
if (QTransaksiKD_TRANSAKSI.AsString='681') and (cbtransaksi.Text='TAMBAHAN') then
  begin
   wwDBGrid1.ColumnByName('NO_BUKTI').ReadOnly:=False;
   QDetailNO_BUKTI.ReadOnly:=False;
  end
else
  begin
   wwDBGrid1.ColumnByName('NO_BUKTI').ReadOnly:=True;
   QDetailNO_BUKTI.ReadOnly:=True;
   QDetail.Refresh;
  end;
wwDBGrid1.Refresh;
...
procedure TPengeluaranPCSFrm.QDetailQTY8Change(Sender: TField);
begin
//MAA 13-01-2020
    QDetailQTY3.AsFloat:=QDetailRASIO.AsFloat*QDetailQTY8.AsFloat;
...
procedure TPengeluaranPCSFrm.QResepBeforeQuery(Sender: TOracleDataSet);
begin
{IF QMasterNO_RESEP.AsString='KELUAR PROSES' THEN
begin
    QResep.DisableControls;
    QResep.Close;
    QResep.SQL.Text:='select * from ipisma_db3.vresep681 WHERE :MYPARAM';
    QResep.Open;
    QResep.EnableControls;
end
ELSE
begin
    QResep.DisableControls;
    QResep.Close;
    QResep.SQL.Text:='select * from ipisma_db3.vresep WHERE :MYPARAM';
    QResep.Open;
    QResep.EnableControls;
end;   }
end;
