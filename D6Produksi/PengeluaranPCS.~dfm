object PengeluaranPCSFrm: TPengeluaranPCSFrm
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelMaster: TPanel
          ...
          object wwDBDateTimePicker222: TwwDBDateTimePicker
            Left = 682
            Top = 64
            Width = 121
            Height = 21
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from vvalidasikeluarbbfrm4')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      ...
      '/*'
      'select a.*, a.rowid from ipisma_db3.bukti4 a'
      'where (a.ibukti=:myparam1) '
      'UNION ALL'
      'select a.*, a.rowid from ipisma_db3.bukti4 a'
      'where (a.no_nota=:myparam2)'
      '*/')
    Variables.Data = {
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      ...
      ':myparam')
    Variables.Data = {
      0300000002000000070000003A4942554B544903000000000000000000000008
  ...
  object QItem: TOracleDataSet
    ...
    Variables.Data = {
      ...
      080000003A504942554B54490300000004000000D007000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QResep: TOracleDataSet
    SQL.Strings = (
      ...
      ' select'
      '   distinct t.*'
      ' from ipisma_db3.VRESEP681 t, ipisma_db4.desain_detail a'
      ...
      ''
      ''
      'select * from ipisma_db3.vresep681 WHERE :MYPARAM'
      ''
      '')
    Variables.Data = {
  ...
  object QCekResep: TOracleDataSet
    SQL.Strings = (
      'select distinct count(*) as njml'
      'from ipisma_db3.bukti4 b, ipisma_db3.bukti_detail4 d'
      'where (b.ibukti=d.ibukti) and b.ispost='#39'1'#39
      'and (kd_transaksi = '#39'681'#39') and d.no_bukti is not null'
      'and d.no_bukti=:vno_resep')
    Variables.Data = {
      03000000010000000A0000003A564E4F5F524553455005000000100000003436
      42422D2D3031343045283031290000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000040000004E4A4D4C010000000000}
    Cursor = crSQLWait
    Session = DMFrm.OS
    Left = 112
    Top = 400
    object QCekResepNJML: TFloatField
      FieldName = 'NJML'
    end
  end
  object QResepNota: TOracleDataSet
    SQL.Strings = (
      'select distinct b.no_nota'
      'from ipisma_db3.bukti4 b, ipisma_db3.bukti_detail4 d'
      'where (b.ibukti=d.ibukti) and b.ispost='#39'1'#39
      'and (kd_transaksi = '#39'681'#39') and d.no_bukti is not null'
      'and d.no_bukti=:vno_resep')
    ...
    Left = 400
    Top = 392
    object QResepNotaNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Size = 22
    end
  end
