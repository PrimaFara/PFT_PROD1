object PermintaanKoreksiCelupFrm: TPermintaanKoreksiCelupFrm
  ...
  object QNewItems: TOracleDataSet
    SQL.Strings = (
      'select'
        ...
        '  0 as qty, 0 as qty2, kd_satuan as satuan, :vkd_sub_lokasi as k' +
        'd_sub_lokasi'
      ...
      'order by nama_item')
    Variables.Data = {
      03000000030000000D0000003A564B445F4A4E535F4954454D05000000030000
      00333000000000000F0000003A564B445F5355425F4C4F4B4153490500000009
      00000032322D30303030300000000000080000003A4D59504152414D01000000
      0000000000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      4B445F5355425F4C4F4B41534901000000000003000000515459010000000000
      05000000524153494F010000000000080000004B445F5741524E410100000000
      00080000004E4F5F424154434801000000000004000000515459320100000000
    ...
    Left = 304
    Top = 328
    object QNewItemsNAMA_ITEM: TStringField
      FieldName = 'NAMA_ITEM'
      Required = True
      Size = 50
    end
    object QNewItemsKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Required = True
      Size = 50
    end
    object QNewItemsRASIO: TFloatField
      FieldName = 'RASIO'
    end
    object QNewItemsKD_WARNA: TStringField
      FieldName = 'KD_WARNA'
      Size = 6
    end
