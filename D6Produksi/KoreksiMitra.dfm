object KoreksiMitraFrm: TKoreksiMitraFrm
  Left = 220
  Top = 29
  Width = 1011
  Height = 590
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelMaster: TPanel
          ...
          object Label20: TLabel
            ...
            Width = 392
            Height = 13
            Caption = '>>> ANGKA NEGATIF (-) DIGUNAKAN UNTUK KOREKSI KELUAR !!!'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clRed
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            ControlType.Strings = (
              ...
              'NO_BATCH;CustomEdit;LookArah;F')
            Selected.Strings = (
              'KD_ITEM'#9'7'#9'KODE'#9'F'
              'KETERANGAN'#9'30'#9'BENANG'#9'T'
              'QTY1'#9'9'#9'QTY KG'#9'F'
              'NO_BATCH'#9'10'#9'ARAH'#9'F')
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            ControlType.Strings = (
              'ISPOST;CheckBox;1;0')
            Selected.Strings = (
              'NO_NOTA'#9'17'#9'NO NOTA'#9'F'#9
              'TGL'#9'8'#9'TGL'#9'F'#9
              'ISPOST'#9'4'#9'ISPOST'#9'F'#9
              'ARAH'#9'8'#9'ARAH'#9'F'#9
              'KD_ITEM'#9'8'#9'KD_ITEM'#9'F'#9
              'KETERANGAN'#9'25'#9'KETERANGAN'#9'F'#9
              'MITRA'#9'20'#9'MITRA'#9'F'#9
              'QTY1'#9'10'#9'QTY'#9'F'#9
              'OPR_INSERT'#9'30'#9'OPR_INSERT'#9'F'#9
              'TGL_INSERT'#9'18'#9'TGL_INSERT'#9'F'#9)
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vkoreksimitrafrm')
    QBEDefinition.QBEFieldDefs = {
      
      540100000000000A00000054474C5F494E53455254010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      ...
      '('
        ...
        'select min(kd_item) as kd_item, kd_sub_kel as nama_item from ipi' +
        'sma_db3.ITEM t'
      'where t.kd_kel='#39'30'#39
      'group by kd_sub_kel'
      ') order by nama_item')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000090000004E414D415F4954454D010000000000070000004B
      445F4954454D010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
