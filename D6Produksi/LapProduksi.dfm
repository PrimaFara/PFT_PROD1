object LapProduksiFrm: TLapProduksiFrm
  Left = 243
  Top = 105
  Width = 1157
  Height = 628
            ...
            object TabSheet1: TTabSheet
              ...
              object wwDBGrid1: TwwDBGrid
                ...
                Selected.Strings = (
                  ...
                  'QTY1'#9'15'#9'Kg'#9'F'#9'HASIL SOFTCONE'
                  'QTY2'#9'10'#9'Pcs'#9'F'#9'HASIL SOFTCONE'
                  'QTY3'#9'15'#9'Kg'#9'F'#9'HASIL MESIN~CELUP'
                  'QTY4'#9'10'#9'Pcs'#9'F'#9'HASIL MESIN~CELUP'
                  'QTY9'#9'12'#9'Kg'#9'F'#9'HSL CELUP~REPROSES'
                  'QTY10'#9'12'#9'Pcs'#9'F'#9'HSL CELUP~REPROSES'
                  'QTY5'#9'15'#9'Kg'#9'F'#9'HASIL MESIN~PENGERING'
                  'QTY6'#9'10'#9'Pcs'#9'F'#9'HASIL MESIN~PENGERING'
                  'QTY7'#9'15'#9'Kg'#9'F'#9'HASIL DEPT DYEING~(Serah Terima ke Gudang Warna)'
                  'QTY8'#9'10'#9'Pcs'#9'F'#9'HASIL DEPT DYEING~(Serah Terima ke Gudang Warna)')
            ...
            object TabSheet2: TTabSheet
              ...
              object wwDBGrid2: TwwDBGrid
                ...
                Selected.Strings = (
                  'NAMA_ITEM'#9'25'#9'NAMA ITEM'#9'F'
                  'QTY1'#9'15'#9'Kg'#9'F'
                  'sc_bale'#9'10'#9'Ball'#9'F'
                  'sc_bale_mtr'#9'10'#9'Ball~per Meter'#9'F'
                  'sc_prod_bale_mtr'#9'12'#9'Produksi~per Meter'#9'F')
                IniAttributes.Enabled = True
                IniAttributes.Delimiter = ';;'
                IniAttributes.CheckNewFields = True
                ExportOptions.ExportType = wwgetHTML
      ...
      object TabSheet5: TTabSheet
        ...
        object wwDBGrid4: TwwDBGrid
          ...
          ControlType.Strings = (
            'ISFIXED;CheckBox;1;0')
          Selected.Strings = (
            'NO_TGL'#9'10'#9'TANGGAL'#9'F'
            'PROSES'#9'20'#9'PROSES'#9'F'
            'QTY_KG'#9'10'#9'KG'#9'F'#9'JUMLAH'
            'QTY_PCS'#9'10'#9'PCS'#9'F'#9'JUMLAH')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetHTML
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.lap_produksi'
      
        'where qty1 <> 0 or qty2 <> 0 or qty3 <> 0 or qty4 <> 0 or qty5 <' +
        '> 0 or qty6 <> 0 or qty7 <> 0 or qty8 <> 0'
      'ORDER BY NAMA_ITEM')
    QBEDefinition.QBEFieldDefs = {
      040000000C000000090000004E414D415F4954454D0100000000000400000051
      ...
      0051545938010000000000090000004E4F5F42454E414E470100000000000400
      000051545939010000000000050000005154593130010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QBrowse2: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vlap_prod_dyeing11')
    QBEDefinition.QBEFieldDefs = {
      04000000040000000600000050524F534553010000000000060000004E4F5F54
      474C010000000000060000005154595F4B47010000000000070000005154595F
      504353010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    ...
    Left = 956
    Top = 256
    object QBrowse2NO_TGL: TStringField
      FieldName = 'NO_TGL'
    end
    ...
    object QBrowse2QTY_PCS: TFloatField
      FieldName = 'QTY_PCS'
      DisplayFormat = '#,0;(#,0);-'
    end
  end
