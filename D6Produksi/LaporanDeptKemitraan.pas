...
uses DM, Pembelian, HasilSoftCones;
...
//  if BPBFrm=Nil then
  begin
    ...
    LaporanDeptKemitraanFrm.PanelHeader.Caption:=LaporanDeptKemitraanFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+LaporanDeptKemitraanFrm.QTransaksiNAMA_TRANSAKSI.AsString;
