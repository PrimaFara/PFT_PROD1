unit PermintaanKoreksiPengering;
...
type
  TPermintaanKoreksiPengeringFrm = class(TForm)
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
//  if BPBFrm=Nil then
  begin
    PermintaanKoreksiPengeringFrm:=TPermintaanKoreksiPengeringFrm.Create(Application);
    PermintaanKoreksiPengeringFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PermintaanKoreksiPengeringFrm.QMaster.ReadOnly:=True;
       PermintaanKoreksiPengeringFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PermintaanKoreksiPengeringFrm.Caption:=UpperCase(pjudul);
    PermintaanKoreksiPengeringFrm.vkode:=pkode;
    PermintaanKoreksiPengeringFrm.vjns_lokasi:=pjns_lokasi;
    PermintaanKoreksiPengeringFrm.vjns_brg:=pjns_brg;
    PermintaanKoreksiPengeringFrm.vjns_trx:=pjns_trx;
    PermintaanKoreksiPengeringFrm.QTransaksi.Open;

    PermintaanKoreksiPengeringFrm.Caption:=UpperCase(pjudul);
    PermintaanKoreksiPengeringFrm.PanelHeader.Caption:=PermintaanKoreksiPengeringFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+PermintaanKoreksiPengeringFrm.QTransaksiNAMA_TRANSAKSI.AsString+' ['+pjns_trx+']';
    PermintaanKoreksiPengeringFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksiPengeringFrm.wwDBGrid1.IniAttributes.SectionName:=PermintaanKoreksiPengeringFrm.Caption+'1';
    PermintaanKoreksiPengeringFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    PermintaanKoreksiPengeringFrm.wwDBGrid1.LoadFromIniFile;
    PermintaanKoreksiPengeringFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksiPengeringFrm.wwDBGrid2.IniAttributes.SectionName:=PermintaanKoreksiPengeringFrm.Caption+'2';
    PermintaanKoreksiPengeringFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    PermintaanKoreksiPengeringFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksiPengeringFrm.Caption+'1',PermintaanKoreksiPengeringFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksiPengeringFrm.Caption+'2',PermintaanKoreksiPengeringFrm.wwDBGrid2);
    PermintaanKoreksiPengeringFrm.wwDBSpinLine1.Value:=PermintaanKoreksiPengeringFrm.wwDBGrid1.RowHeightPercent;
    PermintaanKoreksiPengeringFrm.wwDBSpinLine2.Value:=PermintaanKoreksiPengeringFrm.wwDBGrid2.RowHeightPercent;

  end;

  PermintaanKoreksiPengeringFrm.Show;
end;

procedure TPermintaanKoreksiPengeringFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   PermintaanKoreksiPengeringFrm:=Nil;
end;

procedure TPermintaanKoreksiPengeringFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TPermintaanKoreksiPengeringFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.BtnOkClick(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vjam : string;
 ...
 vjam2 := StrToInt(DMFrm.QHak_JamJAM2.AsString);
  ...
  begin
    ...
    begin
      ...
      if vjns_trx = 'DALAM_PROSES' then vproses:='0';
      if vjns_trx = 'HASIL_PROSES' then vproses:='1';
      ...
      QBrowse.SQL.Text:='select * from '+cUserTabel+'v'+Name+' where tanggal>=:pawal and tanggal<=:pakhir and kd_transaksi=:kd_transaksi and lokasi2='''+vproses+''' :porder';
...
procedure TPermintaanKoreksiPengeringFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPermintaanKoreksiPengeringFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPermintaanKoreksiPengeringFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksiPengeringFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksiPengeringFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TPermintaanKoreksiPengeringFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPermintaanKoreksiPengeringFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.BtnOk2Click(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TPermintaanKoreksiPengeringFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPermintaanKoreksiPengeringFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksiPengeringFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksiPengeringFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPermintaanKoreksiPengeringFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPermintaanKoreksiPengeringFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Close;
...
procedure TPermintaanKoreksiPengeringFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPermintaanKoreksiPengeringFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TPermintaanKoreksiPengeringFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TPermintaanKoreksiPengeringFrm.QMasterBeforePost(DataSet: TDataSet);
begin
  ...
  if QMasterGRUP.AsString='' then
   ...
   begin
     ...
     if vjns_trx = 'DALAM_PROSES' then DMFrm.FNoUrut.SetVariable(1,'0');
     if vjns_trx = 'HASIL_PROSES' then DMFrm.FNoUrut.SetVariable(1,'1');
...
procedure TPermintaanKoreksiPengeringFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPermintaanKoreksiPengeringFrm.Label5Click(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksiPengeringFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksiPengeringFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksiPengeringFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=0;
end;

procedure TPermintaanKoreksiPengeringFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPermintaanKoreksiPengeringFrm.FormCloseQuery(Sender: TObject;
...
procedure TPermintaanKoreksiPengeringFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TPermintaanKoreksiPengeringFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksiPengeringFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPermintaanKoreksiPengeringFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  {
  if modified then
...
procedure TPermintaanKoreksiPengeringFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksiPengeringFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksiPengeringFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksiPengeringFrm.QItemBeforeOpen(DataSet: TDataSet);
begin
{ if wwDBDateTimePicker1.Date >= StrToDate('01/01/2017') then
  begin
    QItem.Close;
...
procedure TPermintaanKoreksiPengeringFrm.wwDBGrid1UpdateFooter(
  Sender: TObject);
begin
  QTotal.Close;
...
procedure TPermintaanKoreksiPengeringFrm.wwDBDateTimePicker1Change(
  Sender: TObject);
begin
  QItem.Refresh;
end;

procedure TPermintaanKoreksiPengeringFrm.wwDBGrid1CalcCellColors(
...
procedure TPermintaanKoreksiPengeringFrm.LookItemUserButton1Click(
...
procedure TPermintaanKoreksiPengeringFrm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBDateTimePicker1.Enabled:=False;
  wwDBComboBox3.Enabled:=False;
...
procedure TPermintaanKoreksiPengeringFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Close;
...
procedure TPermintaanKoreksiPengeringFrm.LookWarnaCloseUp(Sender: TObject;
