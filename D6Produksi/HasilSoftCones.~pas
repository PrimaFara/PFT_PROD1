...
begin
  ...
  begin
    ...
    Worksheet.Cells[1, 1].Value := '791. HASIL PRODUKSI SOFTCONE';
    Worksheet.Range['A1', 'S1'].Merge; // Gabung cell agar judul rata tengah
    ...
    Worksheet.Range['A2', 'S2'].Merge; // Gabung cell agar judul rata tengah
    ...
    Worksheet.Range['A3', 'S3'].Font.Bold := True;
    Worksheet.Range['A3', 'S3'].Font.Size := 10;
    Worksheet.Range['A3', 'S3'].HorizontalAlignment := 3; // xlCenter
