object ValidasiKeluarKeMitraFrm: TValidasiKeluarKeMitraFrm
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY8'#9'15'#9'Pcs'#9'F'#9'DIAMBIL ke MITRA'
              'QTY3'#9'15'#9'Kg'#9'T'#9'DIAMBIL ke MITRA'
              'WARNA'#9'30'#9#9'T'#9'WARNA'
              'KD_WARNA'#9'6'#9'Kode'#9'T'#9'WARNA'
              'KD_SUB_KEL'#9'14'#9'JENIS BENANG'#9'T'
              'KETERANGAN'#9'30'#9'KETERANGAN ITEM PATAL'#9'T'
              'QTY10'#9'15'#9'Pcs'#9'T'#9'AMBIL STOK'
              'QTY9'#9'15'#9'Kg'#9'T'#9'AMBIL STOK'
              'RASIO'#9'7'#9'RASIO'#9'T'
              'QTY6'#9'15'#9'Pcs'#9'T'#9'GUDANG'
              'QTY1'#9'15'#9'Kg'#9'T'#9'GUDANG'
              'KD_SUB_LOKASI2'#9'8'#9'Lokasi'#9'T'#9'GUDANG'
              'NO_BUKTI'#9'15'#9'NO RESEP'#9'F'
              'STATUS'#9'8'#9'ARAH'#9'F')
          ...
          object LookItem: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              'KD_SUB_KEL'#9'12'#9'ITEM BENANG'#9'F'
          ...
          object LookResep: TwwDBLookupComboDlg
            ...
            OnUserButton2Click = LookResepUserButton2Click
            Selected.Strings = (
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY9'#9'10'#9'Kg'#9'F'#9'AMBIL STOK'
              'QTY10'#9'10'#9'Pcs'#9'F'#9'AMBIL STOK'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from vvalidasikeluarMITRAfrm4')
    QBEDefinition.QBEFieldDefs = {
      040000001F000000070000004E4F5F4E4F54410100000000000700000054414E
      ...
      0100000000000400000054544434010000000000040000005154593901000000
      00000500000051545931300100000000000A0000004B445F5355425F4B454C01
      0000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    ...
    object QMasterQTY_BERAT: TFloatField
      FieldName = 'QTY_BERAT'
    end
  ...
  object ppReportInput: TppReport
    ...
    object ppTitleBand2: TppTitleBand
      ...
      object ppLabel31: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Jl. Sapugarut Pekalongan'
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
      ...
      object ppLabel34: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'SURAT JALAN BENANG WARNA'
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
      ...
      object ppLabel16: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Telp +62285 421142 (Hunting);'
        Ellipsis = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      ...
      '/*'
        ...
        'from ipisma_db3.vitem_30_kel a, ipisma_db3.gd_stok b, ipisma_db3' +
        '.warna_baru d'
      'where a.kd_item=b.kd_item and b.kd_warna=d.kd_warna and'
      'a.kd_jns_item ='#39'30'#39' and TRUNC(b.tgl)<=TRUNC(sysdate)'
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        '(qty3) as kg2 from ipisma_db3.bukti_detail4 a'
      'where ibukti = :ibukti')
  ...
  object QResep: TOracleDataSet
    SQL.Strings = (
      ...
      ' select'
      '   distinct t.*'
      ' from ipisma_db3.VRESEP682 t, ipisma_db4.desain_detail a'
      
        ' where t.no_desain=a.no_desain and (a.nama_item = :pnama_item AN' +
        'D a.kd_warna=:pkd_warna)'
      ') WHERE :MYPARAM'
      ''
      ''
      '/*select * from ipisma_db3.vresep682 WHERE :MYPARAM*/'
      ''
      '')
    Variables.Data = {
      0300000003000000080000003A4D59504152414D01000000110000004E4F5F52
      45534550204C494B4520272700000000000A0000003A504B445F5741524E4105
      00000000000000000000000B0000003A504E414D415F4954454D050000000000
      000000000000}
    QBEDefinition.QBEFieldDefs = {
