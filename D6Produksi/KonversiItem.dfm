object KonversiItemFrm: TKonversiItemFrm
  Left = 262
  Top = 118
  Width = 1013
  Height = 634
  Caption = 'Konversi Item'
  Color = clBtnFace
      ...
      object TabSheet2: TTabSheet
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Height = 365
            ControlType.Strings = (
              'KD_ITEM_PURCHASE;CustomEdit;LookItemPurchase;F')
            Selected.Strings = (
              'KD_ITEM_PURCHASE'#9'10'#9'KD_ITEM'#9'F'#9'PURCHASING'
              'NAMA_ITEM_PURCHASE'#9'40'#9'NAMA ITEM'#9'F'#9'PURCHASING'
              'KD_ITEM_P1'#9'10'#9'KD_ITEM'#9'F'#9'PROD 1'
              'NAMA_ITEM_P1'#9'40'#9'NAMA ITEM'#9'F'#9'PROD 1')
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
            ExportOptions.ExportType = wwgetHTML
          ...
          object LookItemPurchase: TwwDBLookupComboDlg
            Left = 80
            Top = 80
            Width = 121
            Height = 19
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.kd_pgd as kd_item_purchase, c.nama_item as nama_item_pu' +
        'rchase, a.kd_item as kd_item_p1, b.nama_item as nama_item_p1, a.' +
        'rowid'
      'from ipisma_db3.KONV_PGD_PROD a'
      'left join ipisma_db3.item b on a.kd_item=b.kd_item'
      'left join pmtx01.item@gjduduk c on a.kd_pgd=c.kd_item'
      'where a.kd_item like '#39'10.%'#39
      ''
      ''
      ''
      ''
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000004000000100000004B445F4954454D5F505552434841534501000000
      0000120000004E414D415F4954454D5F50555243484153450100000000000A00
      00004B445F4954454D5F50310100000000000C0000004E414D415F4954454D5F
      5031010000000000}
    ...
    Left = 824
    Top = 8
    object QBrowseKD_ITEM_PURCHASE: TStringField
      DisplayWidth = 20
      FieldName = 'KD_ITEM_PURCHASE'
    end
    object QBrowseNAMA_ITEM_PURCHASE: TStringField
      DisplayWidth = 80
      FieldName = 'NAMA_ITEM_PURCHASE'
      Size = 80
    end
    object QBrowseKD_ITEM_P1: TStringField
      DisplayWidth = 20
      FieldName = 'KD_ITEM_P1'
      Required = True
    end
    object QBrowseNAMA_ITEM_P1: TStringField
      DisplayWidth = 50
      FieldName = 'NAMA_ITEM_P1'
      Size = 50
    end
  end
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      'select kd_item, nama_item, kd_satuan from pmtx01.item@gjduduk'
      '/*select * from ipisma_db3.vitemALL*/'
      'where kd_item like '#39'1%'#39)
    QBEDefinition.QBEFieldDefs = {
