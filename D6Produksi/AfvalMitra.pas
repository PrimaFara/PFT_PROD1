...
//  if BPBFrm=Nil then
  begin
    AfvalMitraFrm:=TAfvalMitraFrm.Create(Application);
    AfvalMitraFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       AfvalMitraFrm.QMaster.ReadOnly:=True;
       AfvalMitraFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    AfvalMitraFrm.Caption:=UpperCase(pjudul);
    AfvalMitraFrm.vkode:=pkode;
    AfvalMitraFrm.vjns_lokasi:=pjns_lokasi;
    AfvalMitraFrm.vjns_brg:=pjns_brg;
    AfvalMitraFrm.vjns_item:=pjns_item; //MAA 19-12-2019
    AfvalMitraFrm.QTransaksi.Open;

    AfvalMitraFrm.PanelHeader.Caption:=AfvalMitraFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+AfvalMitraFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    AfvalMitraFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    AfvalMitraFrm.wwDBGrid1.IniAttributes.SectionName:=AfvalMitraFrm.Caption+'1';
    AfvalMitraFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    AfvalMitraFrm.wwDBGrid1.LoadFromIniFile;
    AfvalMitraFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    AfvalMitraFrm.wwDBGrid2.IniAttributes.SectionName:=AfvalMitraFrm.Caption+'2';
    AfvalMitraFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    AfvalMitraFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,AfvalMitraFrm.Caption+'1',AfvalMitraFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,AfvalMitraFrm.Caption+'2',AfvalMitraFrm.wwDBGrid2);
    AfvalMitraFrm.wwDBSpinLine1.Value:=AfvalMitraFrm.wwDBGrid1.RowHeightPercent;
    AfvalMitraFrm.wwDBSpinLine2.Value:=AfvalMitraFrm.wwDBGrid2.RowHeightPercent;
  end;

  AfvalMitraFrm.Show;
end;

procedure TAfvalMitraFrm.FormClose(Sender: TObject;
...
procedure TAfvalMitraFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TAfvalMitraFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.BtnOkClick(Sender: TObject);
var
  vkg : real;
  vjam : string;
  vjam1,vjam2 : Integer;
...
procedure TAfvalMitraFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TAfvalMitraFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TAfvalMitraFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TAfvalMitraFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TAfvalMitraFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TAfvalMitraFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TAfvalMitraFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.BtnOk2Click(Sender: TObject);
var
  vkgf : real;
begin
...
procedure TAfvalMitraFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TAfvalMitraFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TAfvalMitraFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TAfvalMitraFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TAfvalMitraFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
...
procedure TAfvalMitraFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TAfvalMitraFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TAfvalMitraFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Close;
...
procedure TAfvalMitraFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TAfvalMitraFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TAfvalMitraFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
procedure TAfvalMitraFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TAfvalMitraFrm.Label5Click(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Close;
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TAfvalMitraFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TAfvalMitraFrm.FormCloseQuery(Sender: TObject;
...
procedure TAfvalMitraFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TAfvalMitraFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TAfvalMitraFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Close;
...
procedure TAfvalMitraFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
//    QItem.Close;
...
procedure TAfvalMitraFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TAfvalMitraFrm.FormShow(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.QDetailQTY6Change(Sender: TField);
begin
...
procedure TAfvalMitraFrm.LookMesinEnter(Sender: TObject);
begin
  QLokasi.Close;
  QLokasi.SetVariable('pkd_lokasi',vjns_lokasi);
...
procedure TAfvalMitraFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TAfvalMitraFrm.LookWarnaEnter(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  if (QDetailQTY4.AsFloat>0) then
    QDetailEFF.AsFloat:=100*QDetailQTY1.AsFloat/(QDetailQTY4.AsFloat);
end;

procedure TAfvalMitraFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TAfvalMitraFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
   ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TAfvalMitraFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TAfvalMitraFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TAfvalMitraFrm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBDateTimePicker1.Enabled:=False;
end;

procedure TAfvalMitraFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
//  vfilter:=vkd_benang;
...
procedure TAfvalMitraFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
