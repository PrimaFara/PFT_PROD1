object PenerimaanHasilCelupFrm: TPenerimaanHasilCelupFrm
  Left = 247
  Top = 101
  Width = 1086
  Height = 600
  Caption = 'PENERIMAAN HASIL CELUP'
  Color = clBtnFace
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'KD_SUB_KEL'#9'14'#9'JENIS BENANG'#9'T'
              'KETERANGAN'#9'32'#9'KETERANGAN ITEM PATAL'#9'T'
          ...
          object LookItem: TwwDBLookupComboDlg
            ...
            MaxHeight = 209
            Selected.Strings = (
              'KD_SUB_KEL'#9'14'#9'JENIS BENANG'#9'F'
              'KD_ITEM'#9'10'#9'KODE'#9'F'
              'NAMA_ITEM'#9'35'#9'KETERANGAN ITEM PATAL'#9'F'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vvalidasipenyerahanbbfrm4')
    QBEDefinition.QBEFieldDefs = {
      ...
      
      05000000524153494F010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db3.bukti4 a'
    ...
    OnApplyRecord = QMasterApplyRecord
    Session = DMFrm.OS
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db3.bukti_detail4 a'
      'where a.ibukti=1018773 ')
    QBEDefinition.QBEFieldDefs = {
    ...
    BeforeDelete = QMasterBeforeDelete
    AfterDelete = QDetailAfterDelete
    ...
    object QDetailKD_SUB_KEL: TStringField
      FieldKind = fkLookup
  ...
  object QLokasi: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vlokasi1')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QItem: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      5F5355425F4B454C01000000000006000000524153494F320100000000000900
      00004E4F5F42454E414E47010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
  ...
  object QHasilCelup: TOracleDataSet
    SQL.Strings = (
      'select '
      'x.*, v.kd_item_benang, v.nama_item as nama_item_benang'
      'from'
      '('
      'select '
      #39'30.'#39'||substr(a.kd_item,4,10) as kd_item30,'
      'a.keterangan as keterangan30,'
      'a.rasio,'
      'a.kd_satuan,'
      'a.no_batch,'
      'a.kd_warna,'
      'a.qty2,'
      'a.qty7'
      'from ipisma_db3.bukti_detail a, ipisma_db3.bukti b '
      
        'where b.kd_transaksi='#39'796'#39' and ispost='#39'1'#39' and a.ibukti=b.ibukti ' +
        'and b.no_nota=:no_nota'
      ') x, ipisma_db3.vkonversi_item_benang30 v'
      'where x.kd_item30=v.kd_item(+)'
      ''
      ''
      
        '----------------------------------------------------------------' +
        '---------'
      '--select a.* from ipisma_db3.bukti_detail a, ipisma_db3.bukti b '
      '--where a.ibukti=b.ibukti and b.no_nota=:no_nota')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      0000000000}
    Cursor = crSQLWait
    Session = DMFrm.OS
    ...
    Left = 64
    Top = 248
    object QHasilCelupKD_ITEM30: TStringField
      FieldName = 'KD_ITEM30'
      Size = 13
    end
    object QHasilCelupKETERANGAN30: TStringField
      FieldName = 'KETERANGAN30'
      Size = 255
    end
    ...
    object QHasilCelupKD_ITEM_BENANG: TStringField
      FieldName = 'KD_ITEM_BENANG'
    end
    object QHasilCelupNAMA_ITEM_BENANG: TStringField
      FieldName = 'NAMA_ITEM_BENANG'
      Size = 50
    end
  end
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty1) as qty1, sum(qty6) as qty6 from ipisma_db3.bukt' +
        'i_detail4 a'
  ...
  object QDel: TOracleQuery
    SQL.Strings = (
      'begin'
      '  commit;'
      '  delete ipisma_db3.bukti_detail4 where ibukti=:pno_ibukti;'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000010000000B0000003A504E4F5F4942554B5449030000000000000000
      000000}
    Cursor = crSQLWait
    Left = 68
    Top = 295
  end
  object QCek796: TOracleDataSet
    SQL.Strings = (
      'select count(b.no_bukti) as N796'
      'from ipisma_db3.bukti4 b '
      'where b.no_bukti=:no_nota')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000040000004E373936010000000000}
    Cursor = crSQLWait
    Session = DMFrm.OS
    BeforeOpen = QHasilCelupBeforeOpen
    Left = 64
    Top = 344
    object QCek796N796: TFloatField
      FieldName = 'N796'
    end
  end
  object QCekItemKEL: TOracleDataSet
    SQL.Strings = (
      'select count(*) as jmlNull from'
      '('
      'select '
      'v.kd_item_benang'
      'from'
      ...
      'where x.kd_item30=v.kd_item(+)'
      ')'
      'where kd_item_benang is null')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000F0000003739362D
      313930342D30303133300000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000070000004A4D4C4E554C4C010000000000}
    Cursor = crSQLWait
    Session = DMFrm.OS
    BeforeOpen = QHasilCelupBeforeOpen
    Left = 64
    Top = 416
    object QCekItemKELJMLNULL: TFloatField
      FieldName = 'JMLNULL'
    end
  end
end
