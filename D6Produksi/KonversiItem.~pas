...
type
  TKonversiItemFrm = class(TForm)
    ...
    QBrowseKD_ITEM_PURCHASE: TStringField;
    QBrowseNAMA_ITEM_PURCHASE: TStringField;
    QBrowseKD_ITEM_P1: TStringField;
    QBrowseNAMA_ITEM_P1: TStringField;
    Panel1: TPanel;
    BtnOk: TBitBtn;
    BtnEditing4: TSpeedButton;
    BtnBrowse4: TSpeedButton;
    LookItemPurchase: TwwDBLookupComboDlg;
...
var
  KonversiItemFrm: TKonversiItemFrm;

procedure ShowForm(pNamaMenu:String; pjns : String; pbrg : string);

implementation

uses DM, Pembelian, OrganisasiItem;
...
//  if OrganisasiItemFrm=Nil then
  begin
    ...
    pBrg:=mychar;
    KonversiItemFrm.vjns:=copy(pbrg,1,2);
    if KonversiItemFrm.vjns='60' then
       OrganisasiItemFrm.cbResep.Caption:='Kendaraan/ Alat'
       else
       OrganisasiItemFrm.cbResep.Caption:='Punya Resep';
    KonversiItemFrm.vbrg:=UpperCase(pbrg);
...
procedure TKonversiItemFrm.FormClose(Sender: TObject;
...
procedure TKonversiItemFrm.FormCreate(Sender: TObject);
begin
...
procedure TKonversiItemFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKonversiItemFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKonversiItemFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKonversiItemFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKonversiItemFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKonversiItemFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKonversiItemFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKonversiItemFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKonversiItemFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKonversiItemFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=0;
end;

procedure TKonversiItemFrm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TKonversiItemFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKonversiItemFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportBrowse;
  ppDesigner1.ShowModal;
end;

procedure TKonversiItemFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TKonversiItemFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKonversiItemFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKonversiItemFrm.TabSheet1Show(Sender: TObject);
begin
  {
...
procedure TKonversiItemFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKonversiItemFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TKonversiItemFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QItem.Close;
...
procedure TKonversiItemFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
 QKelompok.Close;
 QKelompok.Open;
...
procedure TKonversiItemFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
...
procedure TKonversiItemFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKonversiItemFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKonversiItemFrm.wwDBLookupComboDlg4CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKonversiItemFrm.Label8Click(Sender: TObject);
begin
 QKelompok.Close;
 QKelompok.Open;
...
procedure TKonversiItemFrm.Label7Click(Sender: TObject);
begin
 QSubKelompok.Close;
 QSubKelompok.Open;
...
procedure TKonversiItemFrm.Label16Click(Sender: TObject);
begin
 QMerk.Close;
 QMerk.Open;
...
procedure TKonversiItemFrm.Label10Click(Sender: TObject);
begin
...
procedure TKonversiItemFrm.QSubKelompokNewRecord(DataSet: TDataSet);
begin
  QSubKelompokKD_KEL.AsString:=QKelompokKD_KEL.AsString;
end;

procedure TKonversiItemFrm.QKelompokBeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TKonversiItemFrm.QKelompokNewRecord(DataSet: TDataSet);
begin
  QKelompokKD_JNS_ITEM.AsString:=vjns;
end;

procedure TKonversiItemFrm.QSubKelompokBeforeQuery(
...
procedure TKonversiItemFrm.QSatuanBeforeQuery(Sender: TOracleDataSet);
begin
      QSatuan.SQL.Text:='select a.*, a.rowid from '+cUserTabel+'satuan a'+
        ' order by a.satuan';
end;

procedure TKonversiItemFrm.QWarnaBeforeQuery(Sender: TOracleDataSet);
begin
      QWarna.SQL.Text:='select a.*, a.rowid from '+cUserTabel+'warna a'+
        ' order by a.warna';
end;

procedure TKonversiItemFrm.QMerkBeforeQuery(Sender: TOracleDataSet);
begin
      QMerk.SQL.Text:='select a.*, a.rowid from '+cUserTabel+'merk a'+
        ' order by a.nama_merk';
end;

procedure TKonversiItemFrm.QMerkNewRecord(DataSet: TDataSet);
begin
  QMerkKD_JNS_ITEM.AsString:=vjns;
end;

procedure TKonversiItemFrm.wwDBNavigatorInputButton2Click(
  Sender: TObject);
var
  vkode : string;
  vnomer : integer;
...
procedure TKonversiItemFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailKD_ITEM.AsString:=QMasterKD_ITEM.AsString;
end;

procedure TKonversiItemFrm.QMasterISRESEPChange(Sender: TField);
begin
  wwDBGrid1.Enabled:=QMasterISRESEP.AsString='1';
end;

procedure TKonversiItemFrm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=UpperCase(Caption)+' '+vbrg;
end;

procedure TKonversiItemFrm.BtnDesign1Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportInput;
  ppDesigner1.ShowModal;
end;

procedure TKonversiItemFrm.QMaxKodeBeforeQuery(Sender: TOracleDataSet);
begin
  QMaxKode.SetVariable('KD_JNS_ITEM',vjns);
end;

procedure TKonversiItemFrm.QMasterNAMA_ITEMChange(Sender: TField);
begin
  QMasterDISKRIPSI.AsString:=LKelompok.Caption+
        LSubKelompok.Caption+
        LMerk.Caption+
...
procedure TKonversiItemFrm.QMasterBeforePost(DataSet: TDataSet);
begin
  QMasterKD_SUB_KEL.AsString:=wwDBLookupComboDlg3.Text;
 // QMasterRASIO2.AsFloat:=QMasterRASIO.AsFloat;
end;

procedure TKonversiItemFrm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBLookupComboDlg3.Text:='';
end;

procedure TKonversiItemFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  vnomer:=vnomer+1;
  ppNomer.Caption:=IntToStr(vnomer);
end;

procedure TKonversiItemFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKonversiItemFrm.Label5Click(Sender: TObject);
begin
...
procedure TKonversiItemFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKonversiItemFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  if vjns<>'' then
  begin
...
procedure TKonversiItemFrm.LookItemEnter(Sender: TObject);
begin
  QItem.Close;
  QItem.Open;
end;

procedure TKonversiItemFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
  QSubKelompok.Close;
  QSubKelompok.Open;
end;

procedure TKonversiItemFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
  QMerk.Close;
  QMerk.Open;
end;

procedure TKonversiItemFrm.wwDBLookupComboDlg4Enter(Sender: TObject);
begin
 (sender as TwwDBLookupComboDlg).GridOptions:=(sender as TwwDBLookupComboDlg).GridOptions-
    [dgEditing]-
    [dgAlwaysShowEditor]+
...
procedure TKonversiItemFrm.QMasterRASIOChange(Sender: TField);
begin
//MAA 29-08-2019
...
procedure TKonversiItemFrm.TabSheet2Show(Sender: TObject);
begin
  //MAA 29-08-2019
if vjns='10' then
  begin
...
procedure TKonversiItemFrm.BtnBrowse4Click(Sender: TObject);
begin
...
procedure TKonversiItemFrm.BtnEditing4Click(Sender: TObject);
begin
