object PermintaanKoreksiFrm: TPermintaanKoreksiFrm
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY1'#9'12'#9'Kg'#9'T'#9'AWAL'
              'QTY6'#9'12'#9'Pcs'#9'T'#9'AWAL'
              'QTY4'#9'12'#9'Kg'#9'F'#9'QTY'
              'QTY5'#9'12'#9'Pcs'#9'F'#9'QTY'
              'RASIO'#9'7'#9'RASIO~ISI'#9'T'
              'QTY2'#9'12'#9'Kg'#9'T'#9'AKHIR'
              'QTY7'#9'12'#9'Pcs'#9'T'#9'AKHIR'
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NO_RESEP'#9'10'#9'JENIS'#9'F'
              'KODE_BRG'#9'11'#9'Kode'#9'F'#9'BARANG'
              'NAMA_BRG'#9'24'#9'Nama'#9'F'#9'BARANG'
              'SATUAN'#9'6'#9'Sat'#9'F'#9'BARANG'
              'LOKASI'#9'8'#9'Lokasi'#9'F'
              'QTY1'#9'12'#9'Qty'#9'F'#9'AWAL'
              'SELISIH'#9'12'#9'Qty'#9'F'#9'KOREKSI'
              'QTY2'#9'12'#9'Qty'#9'F'#9'AKHIR'
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      535F4B4F52454B5349010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      'SELECT A.*,B.RASIO2 FROM'
        ...
        '--SELECT * FROM  ==> yang FIX ON SCRIPT DELPHI antara DALAM PROS' +
        'ES & HASIL PROSES <=========='
      '('
      'select'
      'kd_item,'
      ...
      ''
        ...
        '(awmasuk1+awmasuk5+awmasuk3+awkoreksi1) - (awkeluar1+awkeluar5+a' +
        'wkeluar3) as qty,'
      
        '(awmasuk2+awmasuk6+awmasuk4+awkoreksi2) - (awkeluar2+awkeluar6+a' +
        'wkeluar4) as qty2'
      ''
      'from'
      ''
      ...
      '-----------------AWAL KOREKSI KELUAR'
        ...
        '  where jns_koreksi in ('#39'KOREKSI2'#39','#39'KEMITRAAN'#39') and kd_lokasi=:p' +
        'kd_lokasi and kd_item=a.kd_item and kd_transaksi='#39'799'#39' and qty_i' +
        'n<0'
  ...
  object ppReportMitra: TppReport
    AutoStop = False
    DataPipeline = ppDBQDetail
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    ...
    object ppFooterBand3: TppFooterBand
      ...
      mmHeight = 46038
      mmPrintPosition = 0
      object ppUserCetakMitra: TppLabel
        UserName = 'UserCetak'
        HyperlinkColor = clBlue
        Border.BorderPositions = []
        Border.Color = clBlack
  ...
  object QRoundQTY: TOracleDataSet
    SQL.Strings = (
      'select :vQTY as pQTY from dual'
      
        '--select round(:vQTY,4) as pQTY from dual ----KONSEP ROUND QTY, ' +
        'DIDISABLE BERDASARKAN MEETING PRODUKSI'
      '')
    Variables.Data = {
      0300000001000000050000003A5651545904000000080000005F633937DD9ABF
      3F00000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000400000050515459010000000000}
    Cursor = crSQLWait
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 237
    Top = 321
    object QRoundQTYPQTY: TFloatField
      FieldName = 'PQTY'
    end
  end
  object QProc: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db3.proc_temp_lookup_soft0(:vsysdate, :vsysdate2);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
